...
begin
  ...
  if editNomeServidor.Text = '' then
    begin
      ShowMessage('Informe um nome ou ip de servidor para conexão');
      exit;
    end;

    if editUsuarioConexao.Text = '' then
    begin
      ShowMessage('Informe um usuário para conexão');
        exit;
    end;
    if editSenhaAcesso.Text = '' then
    begin
      ShowMessage('Informe uma senha para conexão');
        exit;
    end;
    if editBancoDados.Text = '' then
    begin
      ShowMessage('Informe um nome de banco de dados para conexão');
        exit;
    end;
